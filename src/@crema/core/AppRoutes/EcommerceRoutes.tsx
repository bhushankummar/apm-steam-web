...
const AddProduct = React.lazy(
  () => import("../../../modules/ecommerce/Admin/AddEditProduct/AddTechnician")
);
...
const DeleteProduct = React.lazy(() => import("../../../modules/ecommerce/Admin/DeleteTechnician/DeleteTechnician"));
